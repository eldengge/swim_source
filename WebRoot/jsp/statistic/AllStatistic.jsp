...
<body>
	...
	<div>
		...
		<table class="table" cellspacing="0"
			...
			<tr>
				<td colspan="7" style="text-align: center">全部统计</td>
			</tr>
			<tbody id="tbody">
			</tbody>
		</table>
...
<script type="text/javascript">
	...
	function queryPage(pageno){
		...
		$.ajax({
			url:"${pageContext.request.contextPath}/StatisticServlet",
			type:"POST",
			data:jsonObj,
			dataType:"json",
			beforeSend:function(){
			...
			success: function(result){
				...
				$.each(list,function(i,n){
					context+='<tr>';
					context+='<td>卡号:'+n.user_id+'&nbsp</td>';
					context+='<td>姓名:'+n.user_name+'&nbsp</td>';
					context+='<td>方式:'+n.method+'&nbsp</td>';
					context+='<td>课程:'+n.course_name+'&nbsp</td>';
					context+='<td>日期:'+createDates[i]+'&nbsp</td>';
					context+='</tr>';
				});
				$("#tbody").html(context);
			}
