...
<body>
	...
	<div>
		<center>
          ...
          <form id="idForm" action="${pageContext.request.contextPath}/jsp/user/AddCourse.jsp" method="post">
		...
		$.ajax({
			...
			success:function(result){
				if(result.success==true){
					if(result.allState==1){
						layer.msg("通用卡无需添加课程", {time:1200, icon:5, shift:6});
						var id=$("#idvalue").val("");
					}else{
						var id=$("#idvalue").val()
						window.location='${pageContext.request.contextPath}/jsp/user/AddCourse.jsp?id='+id;
					}
				}else{
